...
/**
 * FFmpeg Jni桥接类
 * 源码地址:https://github.com/zerochl/FFMPEG-AAC-264-Android-32-64
 *
 * @author huqs
 */
...
public class FFmpegBridge {
     ...
     * @param logSavePath String ffmpage 日志保质的路径
     */
    public static native void initJXFFmpeg(boolean debug, String logSavePath);
     ...
     * 注册录制回调
     *
     * @param listener FFmpegStateListener
     */
